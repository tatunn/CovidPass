...
public class AppSectionDataProvider {
    ...
    public required init(header: AppCellDataProvider? = nil,
                         dataProviders: AppCellDataProviders = [],
                         footer: AppCellDataProvider? = nil) {
        self.header = header
